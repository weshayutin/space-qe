...
import com.redhat.rhn.harness.common.Sat51.tasks.RhnBase;

@Test(groups="tests")
public class Authentication extends com.redhat.rhn.harness.satellite51.Authentication{

	@BeforeMethod(groups = { "testplan-Authentication-Satellite" })
