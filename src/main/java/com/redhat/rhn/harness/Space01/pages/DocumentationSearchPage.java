...
import com.redhat.rhn.harness.Sat42.pages.WebList;
import com.redhat.rhn.harness.baseInterface.IRhnBase;
import com.redhat.rhn.harness.common.HarnessConfiguration;
import com.redhat.rhn.harness.common.RhnHelper;


public class DocumentationSearchPage extends com.redhat.rhn.harness.Sat42.pages.DocumentationSearchPage{
...
//		sel.setText("xpath=//th[normalize-space(.)='Search For:']/..//input[@name='search_string']", txt);  // jsefler: will not work when the language changes since "Search For:" will be a different string
		sel.setText("xpath=(//input[@name='search_string'])[last()]", txt);
	}	
...
//		rh.clickButton("xpath=//tr/td[2]/form/div/div/table/tbody/tr/td/input[2]", true);
//      rh.clickButton("xpath=//th[normalize-space(.)='Search For:']/..//input[@value='Search']","Search",true);  // jsefler: will not work when the language changes since "Search For:" will be a different string
        sel.clickAndWait("xpath=(//input[@type='submit' and preceding-sibling::input[@name='search_string']])[last()]");
	}
